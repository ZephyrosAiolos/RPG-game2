...
pair<string,ICON> pairArray[] =
{
    ...
    make_pair("grass1",ICON("grass1",1,4,1,1)),
    make_pair("monster",ICON("monster",6,9,1,1)),
    make_pair("monster1",ICON("monster1",6,9,1,1)),
    make_pair("stone1",ICON("stone1",5,9,1,1)),
    make_pair("fruit1",ICON("fruit1",5,4,1,1))//5,4,1,1
};
